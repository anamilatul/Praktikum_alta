        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              //ada update untuk contact list, jika contact list kosong, maka akan tampil teks contact list masih kosong,
              //jika tidak maka akan muncul contact list
              Expanded(
                child: ListView.builder(
                  shrinkWrap: true,
                  physics: const NeverScrollableScrollPhysics(),
                  itemCount: _contacts.isNotEmpty
                      ? _contacts.length
                      : 1, //ada yg diganti
                  itemBuilder: (context, index) {
                    if (_contacts.isNotEmpty) {
                      ...
                      const Text('Belum ada list contact');
                    }
                  },
                ),
              )
